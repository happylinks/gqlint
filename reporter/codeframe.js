 ...
 * @link https://github.com/eslint/eslint/blob/master/lib/formatters/codeframe.js
 */
'use strict';
...
function formatMessage(message, parentResult) {
  const type = message.fatal || message.severity === 2
    ? chalk.red('error')
  ...
  if (sourceCode) {
    result.push(
      codeFrame(sourceCode, message.line, message.column, {
        highlightCode: false
      })
    );
  }
